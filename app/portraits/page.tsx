...
export default function PortraitsPage() {
  ...
  return <main><div className="page-shell"><SiteHeader />
    ...
    <section className="quiet-panel"><p>Have a person, occasion, or loose idea in mind? The best place to start is a note.</p><Link className="inline-link" href="/inquire">Tell me what you have in mind <span>↗</span></Link></section>
    <SiteFooter />
  </div></main>;
}
